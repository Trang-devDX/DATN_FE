...
import tonghopmon from '../../assets/images/tonghopmon2.jpg'
    ...
    return (
        <div className="justify-center items-centers py-4">
            ...
            <div className="flex justify-center">
                ...
                <div className="w-2/5">
                    <img src={tonghopmon} alt="" className="border rounded-[10%] shadow-xl shadow-[#3B3030]" />
                </div>
            </div>
            <div className="flex justify-center mt-[100px]">
                ...
                <div className="w-2/5">
                    <img src={delivery} alt="" className="border rounded-[10%] shadow-xl shadow-[#3B3030]" />
                </div>
            </div>
            ...
            <div className="flex justify-center mt-[100px]">
                ...
                <div className="w-2/5">
                    <img src={payment} alt="" className="border rounded-[10%] shadow-xl shadow-[#3B3030]" />
                </div>
            </div>
        </div>
    );
