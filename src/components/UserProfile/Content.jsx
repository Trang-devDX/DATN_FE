...
import './Style.css';
import default_avatar from '../../assets/images/avatar/default_avatar.png';
import order from '../../assets/images/shipping_3900732.png';
...
// ====== 9. Xóa ảnh đã thêm trong review mới ======
...
// ====== 10. Xóa ảnh trong đánh giá đã gửi ======
                    ...
                    <div className="flex flex-col h-[400px]">
                        <div className="flex flex-col m-auto">
                            <img
                                src={order}
                                alt="order empty"
                                className="opacity-80 mx-auto h-[60%] w-[60%]"
                            />
...
const handleChangePassword = async () => {
    try {
        ...
        } else if (result && newPassword === password) {
                    ...
                    {reviews ? (
                        reviews.map((item, index) => (
                            <div key={index} className="flex flex-col gap-3 my-4 mx-2 pt-3">
                                <div className="flex">
                                    <img className="h-[100px] w-[100px] object-cover" src={item.product.image} alt="" />
                                        ...
                                        <div className="flex flex-col p-3">
                                            ...
                                            >
                                                ...
                                                <div className="flex my-1">
                                                    ...
                                                    <Rate value={!rating ? item.rating : rating} onChange={setRating} />
                                                </div>
                                                    ...
                                                    {item.images.map((preview, idx) => (
                                                        <div key={idx} className="relative">
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={() => handleRemoveImageUpdate(item.id, idx)}
                                                            >
                                                                X
                                                            </button>
                                                        </div>
                                ...
                                <div className="flex flex-col mb-3 border-t border-gray-400">
                                    <div className="flex ml-2 py-3">
                                        ...
                                        <div className="ml-2">
                                            ...
                                            <Rate style={{ fontSize: 12 }} disabled value={item.rating} />
                                            <p className="text-[17px] italic">{item.content}</p>
                                            <div className="flex mt-2">
                                                {item.images.map((url, idx) => (
                                                    <img key={idx} src={url} className="w-[100px] h-[100px] mr-1" />
                                                ))}
                                            </div>
                                        </div>
                                    </div>
