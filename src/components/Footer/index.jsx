        ...
        <>
            <div className="w-full mt-[30px] bg-[#2e2e2e]">
                <div className="w-[1200px] mx-auto grid grid-cols-4 gap-5">
                    <div className="">
                        <div className="w-[250px] mt-[1px]">
                            <img src={logo} alt="logo" />
                        </div>
                        <p className="text-white mt-[20px]">QuangNam-FOOD - Hệ thống quảng bá và kinh doanh đặc sản Quảng Nam</p>
                    </div>
                    ...
                    <div className="mt-[20px] space-y-3">
                        ...
                        <div className="">
                            ...
                            <span className="text-white">QuangNam-FOOD Hội An</span>
                        </div>
                        <div className="">
                            {' '}
                            <EnvironmentOutlined style={{ color: 'yellow', marginRight: '8px' }} />
                            <span className="text-white">QuangNam-FOOD Huế</span>
                        </div>
                        <div className="">
                            {' '}
                            <EnvironmentOutlined style={{ color: 'green', marginRight: '8px' }} />
                            <span className="text-white">QuangNam-FOOD TP Hồ Chí Minh</span>
                        </div>
                    </div>
                    <div className="mt-[20px] space-y-2">
